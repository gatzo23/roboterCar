...
def Speak(text):
    ...
    authenticator = IAMAuthenticator('vouzDVPm5xebKwXBabH_aOa6lp8ADPdIOp5crTY26XSI')
    service = TextToSpeechV1(authenticator=authenticator)
    service.set_service_url('https://api.eu-de.text-to-speech.watson.cloud.ibm.com/instances/85d78639-fd97-4b13-b45b-b7c92912ff3f')
